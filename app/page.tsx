...
export default function Home() {
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Your content command center</p>
            </div>
            <Button
    ...
    return (
      <div className="flex-1 p-8 overflow-auto">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-900">Content Builder</h1>
            <p className="text-gray-600 mt-1">Build your content strategy foundation</p>
          </div>
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-6">
              ...
              <Card className="bg-white border-gray-200 min-h-[500px] p-6">
                {selectedInsights.length === 0 ? (
                  <div className="space-y-4">
                    <div className="text-center mb-6">
                      <FaLightbulb className="text-5xl mx-auto mb-4 text-gray-400 opacity-50" />
                      <p className="text-gray-600">Select from these key insights to build your content strategy</p>
                    </div>
                    <div className="space-y-3">
                          ...
                          >
                            <CardContent className="p-4">
                              <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                  <div className="text-sm font-medium text-gray-900 mb-1">{mainText}</div>
                                  <div className="text-xs text-gray-600">{whyText}</div>
                                </div>
                              </div>
                            </CardContent>
                          </Card>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600 mt-1">{ideas.length} ideas generated from your content strategy</p>
            </div>
            <div className="flex gap-3">
              <Button
    ...
    return (
      <div className="flex-1 p-8 overflow-auto">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-4xl font-bold text-gray-900">Draft Editor</h1>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-100 rounded-lg p-4">
              <h3 className="text-gray-900 font-semibold mb-3">Voice Adjustment</h3>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm text-gray-700 mb-2 block">Formality</label>
                  <input
                    type="range"
                    min="0"
                    max="100"
                ...
                <div>
                  <label className="text-sm text-gray-700 mb-2 block">Energy</label>
                  <input
                    type="range"
                    min="0"
                    max="100"
      ...
      <div className="flex-1 p-8 overflow-auto">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-1">Deep analytics and patterns from your content</p>
          </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <div className={`${sidebarCollapsed ? 'w-20' : 'w-64'} bg-white border-r border-gray-200 transition-all flex flex-col`}>
        <div className="p-4 border-b border-gray-200 flex items-center justify-between">
          {!sidebarCollapsed && (
            <div className="flex items-center gap-2">
              <FaRocket className="text-[#9333EA] text-2xl" />
              <span className="text-gray-900 font-bold text-lg">CreatorPilot</span>
            </div>
          )}
          <Button
            variant="ghost"
        ...
        <div className="p-4 border-t border-gray-200 space-y-2">
          <Button
            variant="ghost"
            className={`w-full justify-start ${sidebarCollapsed ? 'px-2' : 'px-4'} text-gray-600 hover:text-gray-900 hover:bg-gray-100`}
